...
{
    public abstract class ARHospitalProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ARHospitalProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ARHospitalProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ARHospitalProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ARHospitalProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ARHospitalProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ARHospitalProjectDbContext, Task<T>> func)
        {
            T result;
